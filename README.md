...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=Your-Sql-Server;Database=DronesDB;User Id=sa;Password=Your-Password;Trusted_Connection=False;Encrypt=True;TrustServerCertificate=True;"
  }
}
```
